    ...
    public static void main(String[] args) throws IOException {
        TestTableHelper.execute(new TestTableHelper.Executor() {
            ...
            public void execute(Connection connection, Table table) throws IOException {
                ...
                put3.addColumn(Bytes.toBytes("cf"), Bytes.toBytes("qual1"), Bytes.toBytes("val3"));
                ...
                for (Result res : scanner1) {
                    System.out.println(Bytes.toString(res.getValue(Bytes.toBytes("cf"), Bytes.toBytes("qual1"))));
                }
